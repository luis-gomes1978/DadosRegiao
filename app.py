...
# Só executa o login se o modo de desenvolvimento estiver desativado
if not DEV_MODE:
    authenticator.login()
...
# As mensagens de erro de login só aparecem se não estivermos em modo de desenvolvimento
elif not DEV_MODE:
